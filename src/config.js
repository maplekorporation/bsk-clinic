...
export const CLINIC_CONFIG = {
  ...
  phoneDisplay: process.env.REACT_APP_CLINIC_PHONE_DISPLAY || "+91 8250351187",
  
  // The raw phone number used in tel: links
  phoneRaw: process.env.REACT_APP_CLINIC_PHONE_RAW || "+918250351187",
  ...
  whatsappNumber: process.env.REACT_APP_CLINIC_WHATSAPP || "918250351187",
